...
Взаимодействие осуществляется через командную строку
...
1. create an environment `task_1` with the help of [conda],
   ```
...
2. Create concrete dependencies as `environment.lock.yaml` for the exact reproduction of your
   environment with:
   ```
   conda env export -n task_1 -f environment.lock.yaml
   ```
...
├── src
│   └── task_1              <- Actual Python package where the main functionality goes.
